...
## Goal
Pohtia NotPetya-kyberhyökkäystä.
...
NotPetya vaikutti ukrainalaisen Oschadbankin lisäksi lukuisiin maailmanlaajuisesti suuriin yrityksiin, kuten Maersk, FedEx, Merck, Saint-Gobain, Reckitt Benckiser, Mondelez. Esimerkiksi merirahtijätti Maersk menetti koko maailmanlaajuisen IT-infrastruktuurinsa, mikä pysäytti satamaterminaalit, rahtiseurannan viikoiksi ja pakotti koko IT-järjestelmän korvaamisen. Yhteensä hyökkäys aiheutti globaalisesti arviolta yli 10 miljardin dollarin vahingot, mikä tekee siitä yhden historian kalleimmista kyberiskuista. 

### 3. The CIA principle - and the trick
NotPetya kohdistui ennen kaikkea saatavuuteen (Availability) ja myös eheyteen (Integrity) estämällä pääsyn järjestelmiin ja tuhosi tiedostot ja kiintolevyt käyttökelvottomiksi. Vaikka se tekeytyi lunnasohjelmaksi, saastuneet tiedostot tuhottiin lopullisesti ilman mahdollisuutta palautukseen. Tämä valekiristys oli hämäystä, jolla peiteltiin valtiollista sabotaasia ja saatiin uhrit tuhlaamaan aikaa maksamiseen palauttamisen sijaan.

### 4. The attack technique - initial access through a supply chain
Hyökkääjät murtautuivat ukrainalaisen M.E.Doc-kirjanpito-ohjelmiston päivityspalvelimelle ja saastuttivat automaattiseen päivityksen viruksella. Kun sovellusta käyttäneet yritykset latasivat automaattisen ja luotetun päivityksen, haittaohjelma pääsi suoraan heidän sisäverkkoihinsa. Tämä hyökkäystapa on poikkeuksellisen tehokas, koska se kiertää perinteiset suojaukset käyttämällä organisaation päivityskanavaa ja suorittaa haitallisen koodin järjestelmänvalvojan oikeuksin.
