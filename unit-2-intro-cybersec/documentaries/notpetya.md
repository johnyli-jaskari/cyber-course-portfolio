...
Hyökkääjät murtautuivat ukrainalaisen M.E.Doc-kirjanpito-ohjelmiston päivityspalvelimelle ja saastuttivat automaattiseen päivityksen viruksella. Kun sovellusta käyttäneet yritykset latasivat automaattisen ja luotetun päivityksen, haittaohjelma pääsi suoraan heidän sisäverkkoihinsa. Ohjelmiston päivitysmekanismin saastuttaminen on poikkeuksellisen tehokasta, koska se kiertää perinteiset suojaukset käyttämällä organisaation päivityskanavaa ja suorittaa haitallisen koodin järjestelmänvalvojan oikeuksin.
