...
Teknologian kehityksen kaava neljässä eri vaiheessa on suorituskyvyn nousu ja samalla fyysisen laitteiston vähentäminen. Jokainen sukupolvi ratkaisi edellisen hitauden. Traditionalin fyysiset koneet olivat kankeita ja Virtualization toi avun omilla virtuaalikone käyttöjärjestelmillä. Cloud ratkaisi raskaan VM-infrastruktuurin tekemällä kyseisistä resursseista etänä itsepalveluna tilattavia, ja lopulta Containers teki sovellusten ajamisesta vielä kevyempää.
...
Kiinnitän enemmän huomiota siihen, minne tallennan tärkeät henkilökohtaiset tietoni, ja huolehdin siitä, että niistä on varmuuskopiot.
