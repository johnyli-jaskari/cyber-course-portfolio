...
Varmistin että pystyn pingata retitin HQ:n, käytin komentoa ```ping 64.100.1.1```
...
Yritin ottaa yhteyden HQ reitittimeen komennolla ```telnet 64.100.1.1``` , mutta komento ei onnistunut.
