...
Aloitin simulaation. HTTP käyttää TCP:tä, joten yhteyden muodostaminen ja pakettien vastaanoton kuittaukset kasvattaa ohjausliikenteen määrää mikä lisää verkkoliikennettä paljon. 
