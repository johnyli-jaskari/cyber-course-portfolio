...
PC0 koneella avasin selaimen ja laitoin URL kenttään Default gateway ip osoitteen. Kirjauduin admin tunnuksilla sisään ja sivustolla perustietoja reitittimestä.
...
Muokkasin PC0:n DHCP-asetuksia, jotta se sai uudet IP-asetukset.

<img width="442" height="325" alt="image" src="https://github.com/user-attachments/assets/a84a6bf9-acd9-4413-9cbf-c6a72a0a1ef9" />

Käytin seuraavaksi ip osoitetta 192.168.5.1 selaimessa. Pääsin takaisin reitittimen asetuksiin.
...
## Findings
Sain muodostettua yhteyden laitteiden välillä.

## Issues and how I resolved them
Aluksi tietokoneet saivat väärät IP-osoitteet, joten hain IP-osoitteet uudelleen DHCP-palvelimelta.
