...
```ipconfig /all``` Näyttää edellisten lisäksi tarkempia tietoja, kuten MAC-osoitteen, DHCP-palvelimen ja DNS-palvelimen.

<img width="698" height="688" alt="image" src="https://github.com/user-attachments/assets/c8c13a52-283c-42d8-8bb0-5bf79c2a7fda" />

```tracert www.cisco.pt``` tracert-komento käyttää ICMP-protokollaa palauttaakseen tietoja reitittimistä, joiden kautta paketit kulkevat lähdetietokoneelta kohteeseen.
...
Matkalla ohitetaan 2 reititintä. Reitittimet tunnistaa niiden IP-osoitteista 192.168.1.1 ja 209.165.200.233. Kolmas IP osoite on itse määränpää verkkopalvelin.
...
Tracert-komennon tuloksia oli aluksi vaikea tulkita. Selvitin asian tutkimalla tehtävän verkkolaitteita ja etsimällä missä esiintyy samat IP-osoitteet.
